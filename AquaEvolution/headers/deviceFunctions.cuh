...
//__device__ void exec_fish_move(s_aquarium* aquarium, s_scene* scene, int id);
//__device__ void exec_algae_move(s_aquarium* aquarium, s_scene* scene, int id);
...
//	bool is_fish = aquarium.objects.fish[id];
//	if (is_fish)
//		calc_fish_vector(&aquarium, &scene, id);
//	else
//		calc_algae_vector(&aquarium, &scene, id);
//}
//
//__device__ void calc_fish_vector(s_aquarium* aquarium, s_scene* scene, int id)
//{
